...
def create_html_button_with_link(button_text, link_url):
    html_button = f'<a href="{link_url}" target="_blank"><button>{button_text}</button></a>'
    return html_button
...
def handle_new_messages():
    try:
        ...
        for message in messages:
            ...
            button_output = create_button('Visit Zendtrax','https://www.google.com')
            if command == 'TEXT':
                sender['body'] = button_output
            ...
            #     endpoint = 'messages/text'
                ...
                sender['body'] = "Welcome to Zendtrax\n\n" + \
